...
public class MineSweeper {
    ...
    public void run() 
    {
        ...
        while (true) 
        {
            ...
            row = inp.nextInt();
            System.out.print("Column amount: ");
            col = inp.nextInt();
            System.out.println("====================");

	            if ((row < 0 || row > this.row - 1) || (col < 0 || col > this.col - 1)) 
	            {
	                System.out.println("Please, do not exceed count by!");
	                continue;
	            }
    ...
    { // Mayın tarlası oluşturup ekrana yazma
	    ...
	    {
	        MineSweeper mn = new MineSweeper(3, 4);
	        mn.run();
	    }
}
